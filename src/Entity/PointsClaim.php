...
class PointsClaim
{
    ...
    public const REASON_CODE_ANTI_FRAUD_DAILY_POINTS_CAP = 'ANTI_FRAUD_DAILY_POINTS_CAP';
    public const REASON_CODE_ANTI_FRAUD_DAILY_CLAIMS_CAP = 'ANTI_FRAUD_DAILY_CLAIMS_CAP';
    public const REASON_CODE_ANTI_FRAUD_MONTHLY_POINTS_CAP = 'ANTI_FRAUD_MONTHLY_POINTS_CAP';
    public const REASON_CODE_FREEMIUM_MONTHLY_CLAIMS_QUOTA = 'FREEMIUM_MONTHLY_CLAIMS_QUOTA';
    public const REASON_CODE_COOLDOWN_ACTIVE = 'COOLDOWN_ACTIVE';
